...
public class RuralHouse implements Serializable {
    ...
    public RuralHouse(int houseNumber, Owner owner, String description, String city, int district, int nBedrooms,
        ...
        this.nDiningrooms = nDiningrooms;
        this.nParkingSpaces = nParkingSpaces;
        this.description = description;
        accountNumber = new int[20];
        this.owner = owner;
        this.city = city;
    ...
    public int getNDiningrooms() {
        return nDiningrooms;
    }

    public void setNDiningrooms(int nDiningrooms) {
        this.nDiningrooms = nDiningrooms;
    }
