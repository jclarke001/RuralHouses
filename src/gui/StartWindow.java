...
public class StartWindow extends JFrame {
    ...
    private JButton getBoton4() {
        if (boton4 == null) {
            boton4 = new JButton();
            boton4.setText("Withdraw Property");
            boton4.addActionListener(new java.awt.event.ActionListener() {
                public void actionPerformed(java.awt.event.ActionEvent e) {
                    JFrame a = new LogInGUI(OwnerUseCase.WITHDRAW_PROPERTY);
                    a.setVisible(true);
                }
            });
        }
    ...
    private JButton getBoton5() {
        if (boton5 == null) {
            boton5 = new JButton();
            boton5.setText("Register Property");
            boton5.addActionListener(new java.awt.event.ActionListener() {
                public void actionPerformed(java.awt.event.ActionEvent e) {
                    JFrame a = new LogInGUI(OwnerUseCase.REGISTER_PROPERTY);
                    a.setVisible(true);
                }
            });
        }
